    ...
    Scaffold(
        ...
        NavHost(navController = navController,
            ...
            composable(route = JournalAppScreens.Home.name) {
                HomeScreen(
                    onFabClicked = {navController.navigate(JournalAppScreens.Notes.name)},
                    navigateToUpdateNoteScreen = { noteId ->
                        try {
//                            navController.navigate("${JournalAppScreens.Update.name}/${noteId}")
            ...
            composable("${ JournalAppScreens.Update.name }/{noteId}",
            ...
            composable(JournalAppScreens.Notes.name) {
                AddNoteScreen()
            }
        }
    }
